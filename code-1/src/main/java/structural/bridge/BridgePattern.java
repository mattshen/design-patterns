...
/**
 * Separate actual behaviors from actual objects.
 * In the example, the bridge pattern separates the "drawCircle" behavior from the object "CircleShape".
 * More shapes can be added. e.g. Rectangle
 * More behaviors can be added. e.g. calculateArea()
 */
